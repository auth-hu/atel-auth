...
void main() async {
  ...
  runApp(Swichpages600());
}

class Swichpages600 extends StatefulWidget {
  const Swichpages600({super.key});

  @override
  State<Swichpages600> createState() => _SwichpagesState600();
}

class _SwichpagesState600 extends State<Swichpages600> {
